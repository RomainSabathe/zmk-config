...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_5x15(
        QK_BOOT,  KC_1,    KC_2,    KC_3,    KC_4,          KC_5,    KC_6,    KC_7,    KC_8,   KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_BSPC,
    ...
    [SYM] = LAYOUT_ortho_5x15(
        ...
        _______, _______,        _______,  _______,  QK_AREP,  QK_REP,  _______, _______, _______,     _______,  _______, _______,    _______,      _______, QK_BOOT
    ),
